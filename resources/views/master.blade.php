                ...
                <a class="navbar-brand" href="#">Music</a>
                  ...
                  <div class="collapse navbar-collapse" id="navbar-supported-content">
                    <ul class="navbar-nav mb-2 mb-lg-0">
                      ...
                      <li class="nav-item">
                        <a class="nav-link" href="#0" data-no="2">Albums</a>
                        <div class="circle"></div>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" href="#0" data-no="3">Comments</a>
                        <div class="circle"></div>
                      </li>
                      <li class="nav-item">
            ...
            <div class="page-width-1 page-left">
              <div class="d-flex position-relative tm-border-top tm-border-bottom intro-container">
                <div class="intro-left tm-bg-dark">
                  <h2 class="mb-4">Trending Song</h2>
                  <p class="mb-4">
                ...
                <div class="intro-right">
                  ...
                  <img src="img/home-img-2.jpg" alt="Image" class="img-fluid intro-img-1">
                </div>
          ...
          <li data-page-no="3" class="px-3">
            <div class="position-relative page-width-1 page-right tm-border-top tm-border-bottom">
              ...
              <div class="tm-bg-dark content-pad">
                ...
                <p class="mb-4">
                  You are <span class="highlight">allowed</span> to use Music albums for your personal usage.
                </p>
                  ...
                  <div class="map-outer">
                    <div class="gmap-canvas">
                        <iframe width="100%" height="400" id="gmap-canvas"
                            src="https://www.google.com/maps/place/Swansea+University+Bay+Campus/@51.6298591,-3.9473831,13z&t=&z=13&ie=UTF8&iwloc=&output=embed"
    ...
    <div class="container-fluid">
      <footer class="row mx-auto tm-footer">
        <div class="col-md-6 px-0">
          Copyright 2023 Music Company Limited. All rights reserved.
        </div>
        <div class="col-md-6 px-0 tm-footer-right">
          Designed by <a rel="sponsored" href="https://github.com/onyxwizard/playlist/" target="_blank" class="tm-link-white">AK</a>
        </div>
      </footer>
    </div>
  </div>
